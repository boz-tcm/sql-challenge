...
Select transaction.transaction_id, transaction.transaction_dt, credit_card.cardholder_id, cardholder.cardholder_nm, credit_card.credit_card_nbr, merchant.merchant_nm, merchant_cat.merchant_cat_nm,
...
Group By transaction.transaction_id, transaction.transaction_dt, credit_card.cardholder_id, cardholder.cardholder_nm, credit_card.credit_card_nbr, merchant.merchant_nm, merchant_cat.merchant_cat_nm
...
Create or Replace View testdata_analysis_question_1_cid_02_cid_18 as
...
--Data Analysis Question 2 SQL Query Code for Juptyer Notebook 'visual_data_analysis.ipynb
Create or Replace View data_analysis_question_2_cid_25_h1_2018 as
Select transaction.transaction_dt, credit_card.cardholder_id, cardholder.cardholder_nm, credit_card.credit_card_nbr, merchant.merchant_nm,
merchant_cat.merchant_cat_nm, transaction.transaction_amt as txn_amt
From transaction
Inner Join credit_card on transaction.credit_card_nbr = credit_card.credit_card_nbr
